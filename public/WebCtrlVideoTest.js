    ...
    if (!window.WebVideoCtrl) {
        var e = function() {
            ...
            window.WindowDblClick = function(e) {
                s = e,
                p.cbDoubleClickWnd && p.cbDoubleClickWnd(P, s)
            }
            ,
            ...
            window.PluginEventHandler = function(e, t, n) {
                Z() ? p.cbEvent && p.cbEvent(e, t, n) : (0 == t || 2 == t ? o.I_Stop(e) : 21 == t ? o.I_StopRecord(e) : 3 == t && o.I_StopVoiceTalk(),
            ...
            var b = function() {
              ...
              , L = function(e, t) {
                ...
                return o.I_SendHTTPRequest(t, "ISAPI/Security/token?format=json", r),
                n
            }
              , l = function(e, t, n) {
                o.I_GetSecurityVersion(e, {
                    success: function(e) {
                        oSecurityCap.iKeyIterateNum = parseInt(re.$XML(e).find("keyIterateNum").eq(0).text(), 10),
                    ...
                    success: function(e) {
                        ...
                        if (0 < t.length) {
                            var n = re.$XML(t).eq(0).text()
                              , r = 0;
                            "G.711ulaw" == n ? r = 1 : "G.711alaw" == n ? r = 2 : "G.726" == n ? r = 3 : "MP2L2" == n || "MPEL2" == n ? r = 4 : "G.722.1" == n ? r = 0 : "AAC" == n ? r = 5 : "PCM" == n && (r = 6),
                            s.iAudioType = r
                        }
                        "" !== re.$XML(e).find("audioBitRate").eq(0).text() ? s.m_iAudioBitRate = 1e3 * parseInt(re.$XML(e).find("audioBitRate").eq(0).text(), 10) : s.m_iAudioBitRate = 0,
                        "" !== re.$XML(e).find("audioSamplingRate").eq(0).text() ? s.m_iAudioSamplingRate = 1e3 * parseInt(re.$XML(e).find("audioSamplingRate").eq(0).text(), 10) : s.m_iAudioSamplingRate = 0
                    }
                })
            }
              , G = function(n) {
                ...
                n.oProtocolInc.getSystemCapa(n, {
                    success: function(e) {
                        ...
                        0 < t.length && (n.bSupportWebsocket = "true" === re.$XML(e).find("NetworkCap").eq(0).find("isSupportWebsocket").eq(0).text()),
                        n.bSupportWebsocket = !0,
                        0 < (t = re.$XML(e).find("RacmCap").eq(0).find("isSupportMainAndSubRecord", !0)).length && (n.bSupportSubStreamPlayback = "true" === re.$XML(e).find("RacmCap").eq(0).find("isSupportMainAndSubRecord").eq(0).text()),
              ...
              , W = function(e) {
                ...
                if (k(e))
                    ...
                    r ? t = X(e) : -1 == (t = _(e)).iRtspPort && -1 == t.iDevicePort && (t = X(e)),
                    t.iRtspPort,
                    t.iHttpPort,
                    t.iDevicePort
                }
                ...
                return e.oProtocolInc.getPortInfo(e, {
                    ...
                    success: function(e) {
                        ...
                        for (var n = 0, r = t.length; n < r; n++)
                            "rtsp" === re.$XML(t).eq(n).find("protocol").eq(0).text().toLowerCase() && (s = parseInt(re.$XML(t).eq(n).find("portNo").eq(0).text(), 10)),
                            "http" === re.$XML(t).eq(n).find("protocol").eq(0).text().toLowerCase() && (o = parseInt(re.$XML(t).eq(n).find("portNo").eq(0).text(), 10)),
                            "dev_manage" === re.$XML(t).eq(n).find("protocol").eq(0).text().toLowerCase() && (i = parseInt(re.$XML(t).eq(n).find("portNo").eq(0).text(), 10))
                    },
                    error: function() {
                        i = o = s = -1
                    }
                ...
                return e.oProtocolInc.getUPnPPortStatus(e, {
                    ...
                    success: function(e) {
                        for (var t = re.$XML(e).find("portStatus", !0), n = 0, r = t.length; n < r; n++)
                            "rtsp" == re.$XML(t).eq(n).find("internalPort").eq(0).text().toLowerCase() && (s = parseInt(re.$XML(t).eq(n).find("externalPort").eq(0).text(), 10)),
                            "http" == re.$XML(t).eq(n).find("internalPort").eq(0).text().toLowerCase() && (o = parseInt(re.$XML(t).eq(n).find("externalPort").eq(0).text(), 10)),
                            "admin" == re.$XML(t).eq(n).find("internalPort").eq(0).text().toLowerCase() && (i = parseInt(re.$XML(t).eq(n).find("externalPort").eq(0).text(), 10))
                    },
                    error: function() {
                        i = o = s = -1
                    }
              ...
              , E = function(t) {
                t.oProtocolInc instanceof e && t.oProtocolInc.getSDKCapa(t, {
                    ...
                    success: function(e) {
                        ...
                        t.oStreamCapa.bSupportShttpPlay = "true" === re.$XML(e).find("isSupportHttpPlay").eq(0).text(),
                        t.oStreamCapa.bSupportShttpPlayback = "true" === re.$XML(e).find("isSupportHttpPlayback").eq(0).text(),
                        t.oStreamCapa.bSupportShttpsPlay = "true" === re.$XML(e).find("isSupportHttpsPlay").eq(0).text(),
                        t.oStreamCapa.bSupportShttpsPlayback = "true" === re.$XML(e).find("isSupportHttpsPlayback").eq(0).text(),
                        t.oStreamCapa.bSupportShttpPlaybackTransCode = "true" === re.$XML(e).find("isSupportHttpTransCodePlayback").eq(0).text(),
                        t.oStreamCapa.bSupportShttpsPlaybackTransCode = "true" === re.$XML(e).find("isSupportHttpsTransCodePlayback").eq(0).text(),
                        0 < re.$XML(e).find("ipChanBase", !0).length ? t.oStreamCapa.iIpChanBase = parseInt(re.$XML(e).find("ipChanBase").eq(0).text(), 10) : t.oStreamCapa.iIpChanBase = 1
                    },
                    error: function() {
                        t.oStreamCapa.bObtained = !0
                    }
              ...
              , B = function(e) {
                ...
                v.cookie("webVideoCtrlProxy", RegExp.$2, {
                    raw: !0
                }),
                e
            }
            ...
            this.I_InsertOBJECTPlugin = function(e) {
                ...
                if (Z()) {
                    ...
                    y = v.browser().msie ? document.getElementById(u) : document.getElementsByName(c)[0];
                return null == y && null == y.object ? -1 : ("object" == typeof window.attachEvent && v.browser().msie && (y.attachEvent("GetSelectWndInfo", GetSelectWndInfo),
            ...
            this.I_WriteOBJECT_XHTML = function() {
                return Z() ? -1 : (document.writeln(q()),
                null == (y = v.browser().msie ? document.getElementById(u) : document.getElementsByName(c)[0]) && null == y.object ? -1 : ("object" == typeof window.attachEvent && v.browser().msie && (y.attachEvent("GetSelectWndInfo", GetSelectWndInfo),
                y.attachEvent("ZoomInfoCallback", ZoomInfoCallback),
                y.attachEvent("GetHttpInfo", GetHttpInfo),
                y.attachEvent("PluginEventHandler", PluginEventHandler),
                y.attachEvent("RemoteConfigInfo", RemoteConfigInfo),
            ...
            this.I2_OpenFileDlg = function(t) {
                ...
                return Z() ? y.JS_OpenFileBrowser(t, "").then(function(e) {
                    null != e ? 1 == t ? 100 < e.length && n.resolve(-1) : 130 < e.length && n.resolve(-1) : n.resolve(),
                    n.resolve(e)
                }) : (null != (e = y.HWP_OpenFileBrowser(t, "")) ? 1 == t ? 100 < e.length && n.resolve(-1) : 130 < e.length && n.resolve(-1) : n.resolve(),
                n.resolve(e)),
                n
            }
            ,
            ...
            var F = function(r, s, o, i, a, u, c) {
                ...
                v.extend(e, {
                    success: function(e) {
                        var t, n = new O;
                        n.szIP = r,
                        2 == s ? (n.szHttpProtocol = "https://",
                        n.iHttpsPort = o) : (n.szHttpProtocol = "http://",
                        n.iHttpPort = o),
                        n.iCGIPort = o,
            ...
            this.getAuthType = function(t, n, e, r, s, o) {
                ...
                var i = {
                    async: !0,
                    success: function(e) {
                        t.oAuthType[n] = re.$XML(e).find("sessionIDVersion").eq(0).text(),
                        o()
                    },
                    error: function(e) {
                        500 < e && (t.oAuthType[n] = e),
                        o(e)
                    }
                };
            ...
            this.setDeviceInfo = function(e, t, n, r, s) {
                return (t = new O).szIP = n,
                2 == r ? (t.szHttpProtocol = "https://",
                t.iHttpsPort = s) : (t.szHttpProtocol = "http://",
                t.iHttpPort = s),
                t.iCGIPort = s,
            ...
            this.successV1cb = function(e, t, n, r, s, o, i, a) {
                (t = this.setDeviceInfo(e, t, n, r, s)).szAuth = re.$XML(o).find("sessionID").eq(0).text();
                ...
                u.sesstionTimer = setInterval(function() {
                    e.sessionHeartbeat(u, function() {
                        ...
                        u.sessionFailed++,
                        5 <= u.sessionFailed && (window.PluginEventHandler(null, -1, u.szDeviceIdentify),
            ...
            this.successV2cb = function(e, t, n, r, s, o, i, a) {
                (t = this.setDeviceInfo(e, t, n, r, s)).szAuth = L(0, t.szDeviceIdentify),
                w(t),
                b("使用%s协议登录成功", x),
            ...
            this.I_GetSecurityVersion = function(e, t) {
                ...
                if (-1 != n) {
                    ...
                    v.extend(s, t),
                    r.oProtocolInc.getSecurityVersion(r, s)
                }
            }
            ,
            ...
            this.I_Stop = function(e) {
                ...
                if (-1 != n) {
                    var r = m[n];
                    if (r.bRecord && (Z() || y.HWP_StopSave(r.iIndex)),
                    r.bSound && (Z() || y.HWP_CloseSound()),
                    r.bEZoom && (Z() || y.HWP_DisableZoom(r.iIndex)),
                    Z())
                        y.JS_Stop(t.iWndIndex).then(function() {
                            m.splice(n, 1),
                            t.success && t.success()
                        }, function() {
                            t.error && t.error()
                        ...
                        0 == y.HWP_Stop(t.iWndIndex) ? (m.splice(n, 1),
                        t.success && t.success()) : t.error && t.error()
                } else
                    t.error && t.error()
            }
            ,
            ...
            this.I_SetVolume = function(e, t) {
                ...
                isNaN(e) || e < 0 || 100 < e || (t = M(t) ? P : t,
                -1 != this.findWndIndexByIndex(t) && (n = Z() ? (y.JS_SetVolume(t, e),
                0) : y.HWP_SetVolume(t, e))),
                n
            }
            ,
            this.I2_CapturePic = function(e, t) {
                ...
                if (-1 != r)
                    if (Z()) {
                        var o = "JPEG";
                        ".jpg" === e.slice(-4).toLowerCase() ? e = e.slice(0, -4) : ".jpeg" === e.slice(-5).toLowerCase() ? e = e.slice(0, -5) : ".bmp" === e.slice(-4).toLowerCase() && (e = e.slice(0, -4),
                        o = "BMP"),
                        y.JS_CapturePicture(n.iWndIndex, e, o).then(function() {
                            s.resolve()
                        }, function() {
                            s.reject()
                        })
                        ...
                        0 === y.HWP_CapturePicture(n.iWndIndex, e, n.bDateDir) ? s.resolve() : s.reject();
                else
                    s.reject();
                return s
            }
            ...
            this.I_StartRecord = function(e, t) {
                ...
                if (-1 != r) {
                    ...
                    if (s.bRecord)
                        ...
                        v.browser().chrome ? y.JS_StartSave(n.iWndIndex, e).then(function() {
                            s.bRecord = !0,
                            n.success && n.success()
                        }, function() {
                            n.error && n.error()
                        ...
                        0 == y.HWP_StartSave(n.iWndIndex, e, n.bDateDir) ? (s.bRecord = !0,
                        n.success && n.success()) : n.error && n.error()
                } else
                    n.error && n.error()
            }
            ,
            this.I_StopRecord = function(e) {
                ...
                if (-1 != n) {
                    ...
                    if (r.bRecord)
                        if (Z())
                            v.browser().chrome ? y.JS_StopSave(t.iWndIndex).then(function() {
                                r.bRecord = !1,
                                t.success && t.success()
                            }, function() {
                                t.error && t.error()
                            ...
                            0 == y.HWP_StopSave(t.iWndIndex) ? (r.bRecord = !1,
                            t.success && t.success()) : t.error && t.error();
                    else
                        t.error && t.error()
                } else
            ...
            this.I_DisableEZoom = function(e) {
                ...
                if (-1 != t) {
                    var r = m[t];
                    r.bEZoom && 0 == (n = Z() ? y.JS_DisableZoom(e) : (y.HWP_DisableZoom(e),
                    0)) && (r.bEZoom = !1)
                }
                return n
            }
            ...
            this.I_Disable3DZoom = function(e) {
                ...
                if (-1 != t) {
                    var r = m[t];
                    r.b3DZoom && 0 == (n = (Z() ? y.JS_Disable3DZoom(e) : y.HWP_DisableZoom(e),
                    0)) && (r.b3DZoom = !1)
                }
                return n
            }
            ...
            this.I_StartPlayback = function(e, t) {
                ...
                -1 != n) {
                    ...
                    if (Z()) {
                        ...
                        o = 0 == parseInt(re.$XML(g).find("ProtocolType").eq(0).text(), 10) && l.oStreamCapa.bSupportShttpPlay ? (r = M(c.oTransCodeParam) ? l.oProtocolInc.CGI.startShttpPlayback : l.oProtocolInc.CGI.startTransCodePlayback,
                        s = "http://",
                        a = c.iStreamType - 1,
                        ...
                        c.iPort)) : (r = l.oProtocolInc.CGI.startPlayback,
                        s = "rtsp://",
                        a = c.iStreamType,
            ...
            this.I_ReversePlayback = function(e, t) {
                ...
                -1 != n) {
                    ...
                    if (Z())
                        return r;
                    if (-1 == (i = 0 == parseInt(re.$XML(g).find("ProtocolType").eq(0).text(), 10) && d.oStreamCapa.bSupportShttpPlay ? (s = d.oProtocolInc.CGI.startShttpReversePlayback,
                    o = "http://",
                    u = l.iStreamType - 1,
                    a = 100 * (a = l.iChannelID <= d.iAnalogChannelNum ? l.iChannelID : d.oStreamCapa.iIpChanBase + parseInt(l.iChannelID, 10) - d.iAnalogChannelNum - 1) + u,
                    M(l.iPort) ? "https://" == d.szHttpProtocol ? (-1 == d.iHttpPort && (d.iHttpPort = W(d).iHttpPort),
                    d.iHttpPort) : d.iCGIPort : (d.iHttpPort = l.iPort,
                    l.iPort)) : (s = d.oProtocolInc.CGI.startPlayback,
                    o = "rtsp://",
                    u = l.iStreamType,
                    ...
                    -1 == (n = this.findWndIndexByIndex(l.iWndIndex)) && (l.szStartTime = l.szStartTime.replace(/[-:]/g, "").replace(" ", "T") + "Z",
                    l.szEndTime = l.szEndTime.replace(/[-:]/g, "").replace(" ", "T") + "Z",
                    r = d.oProtocolInc.reversePlayback(d, l))
                }
                return -1 == r && (d.iRtspPort = -1),
                r
            }
            ,
            this.I_Frame = function(e) {
                ...
                if (-1 != n) {
                    ...
                    if (2 == s || 4 == s)
                        if (Z())
                            y.JS_FrameForward(t.iWndIndex).then(function() {
                                r.iPlayStatus = 4,
                                t.success && t.success()
                            }, function() {
                                t.error && t.error()
                            ...
                            0 == y.HWP_FrameForward(t.iWndIndex) ? (r.iPlayStatus = 4,
                            t.success && t.success()) : t.error && t.error();
                    else
                        t.error && t.error()
                } else
            ...
            this.I_Pause = function(e) {
                ...
                if (-1 != n) {
                    ...
                    if (Z())
                        y.JS_Pause(t.iWndIndex).then(function() {
                            r.iPlayStatus = o,
                            t.success && t.success()
                        }, function() {
                            t.error && t.error()
                        ...
                        0 == y.HWP_Pause(t.iWndIndex) ? (r.iPlayStatus = o,
                        t.success && t.success()) : t.error && t.error()
                } else
                    t.error && t.error()
            }
            ...
            this.I_Resume = function(e) {
                ...
                if (-1 != n) {
                    ...
                    if (Z())
                        y.JS_Resume(t.iWndIndex).then(function() {
                            r.iPlayStatus = o,
                            t.success && t.success()
                        }, function() {
                            t.error && t.error()
                        ...
                        0 == y.HWP_Resume(t.iWndIndex) ? (r.iPlayStatus = o,
                        t.success && t.success()) : t.error && t.error()
                } else
                    t.error && t.error()
            }
            ...
            this.I_GetOSDTime = function(e) {
                ...
                if (a(e) ? v.extend(n, e) : M(e) || (n.iWndIndex = e),
                -1 != this.findWndIndexByIndex(n.iWndIndex)) {
                    if (Z())
                        y.JS_GetOSDTime(n.iWndIndex).then(function(e) {
                            if (n.success) {
            ...
            this.I_GetDownloadStatus = function(e) {
                var t = -1;
                return Z() || 1 == (t = y.HWP_GetDownloadStatus(e)) && (t = -1),
                t
            }
            ,
            ...
            this.I_RemoteConfig = function(e, t) {
                ...
                if (-1 == s.iDevicePort)
                    if (-1 == o.iDevicePort) {
                        if (o.iDevicePort = W(o).iDevicePort,
                        -1 == (r = o.iDevicePort))
                            return -1
                    } else
                        r = o.iDevicePort;
            ...
            this.I_ChangeWndNum = function(e) {
                return isNaN(parseInt(e, 10)) ? -1 : (Z() ? y.JS_ArrangeWindow(e) : y.HWP_ArrangeWindow(e),
                0)
            }
            ,
            ...
            this.I2_SetSnapPolygonInfo = function(e, t) {
                if (Z()) {
                    ...
                    var n = v.loadXML(t)
                      , r = [];
                    for (nodeList = re.$XML(n).find("SnapPolygon", !0),
                    i = 0,
                    iLen = nodeList.length; i < iLen; i++) {
                        node = nodeList[i];
                        ...
                        for (var o = [], a = re.$XML(node).find("point", !0), u = 0, c = a.length; u < c; u++)
                            oNodePoint = a[u],
                            o.push([500 * re.$XML(oNodePoint).find("x").eq(0).text(), 300 * re.$XML(oNodePoint).find("y").eq(0).text()]);
                        r.push({
                            iPolygonType: 1,
            ...
            this.I_SetSnapPolygonInfo = function(e, t) {
                if (Z()) {
                    var n = y.JS_GetPolygonInfo()
                      ...
                      , s = [];
                    for (a = 0,
                    u = (p = re.$XML(r).find("SnapPolygon", !0)).length; a < u; a++) {
                        h = p[a];
                ...
                u = p.length; a < u; a++)
                    h = p[a],
                    i.push(re.$XML(h).find("id").eq(0).text());
                if (S = "," + (S = i.join(",")) + ",",
                r = v.loadXML(t),
                ...
                u = p.length; a < u; a++) {
                    ...
                    if (!("true" === re.$XML(h).find("isClosed").eq(0).text())) {
                        if (l = re.$XML(h).find("MinClosed").eq(0).text(),
                        !v.isInt(l))
                            return -2;
                        if ((P = parseInt(l, 10)) < 4 || 17 < P)
                            return -2;
                        if (d = re.$XML(h).find("PointNumMax").eq(0).text(),
                        !v.isInt(d))
                            return -2;
                        if ((I = parseInt(d, 10)) < P || 17 < I)
                            return -2
            ...
            K.prototype.submitRequest = function() {
                ...
                if (Z()) {
                    ...
                    this.options.async ? (s.timeout = this.options.timeout,
            ...
            K.prototype.processCallback = function(e, t) {
                ...
                null != n && (this.httpDataAnalyse(n, t),
                delete n)
            }
            ,
            K.prototype.httpDataAnalyse = function(e, t) {
                var n = ""
                  , r = 0;
                "" == t || M(t) ? e.funErrorCallback() : (r = parseInt(t.substring(0, 3)),
                n = t.substring(3, t.length),
                isNaN(r) ? e.funErrorCallback() : 200 == r ? this.options && -1 < this.options.url.indexOf("?format=json") ? e.funSuccessCallback(JSON.parse(n)) : e.funSuccessCallback(v.loadXML(n)) : e.funErrorCallback && e.funErrorCallback(r, v.loadXML(n)))
            }
            ;
            var e = function() {};
            e.prototype.CGI = {
            ...
            e.prototype.getAudioInfo = function(e, n) {
                var t = T(this.CGI.getAudioInfo, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getSecurityVersion = function(e, n) {
                var t = T(this.CGI.getSecurityVersion, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getDeviceInfo = function(e, n) {
                var t = T(this.CGI.getDeviceInfo, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getAnalogChannelInfo = function(i, a) {
                var e = T(this.CGI.getAnalogChannelInfo, i.szHttpProtocol, i.szIP, i.iCGIPort)
                  , t = new K
                  , n = {
                    type: "GET",
                    url: e,
            ...
            e.prototype.getDigitalChannel = function(e, i) {
                var t = T(this.CGI.getDigitalChannel, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , n = new K
                  , r = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getDigitalChannelInfo = function(e, a) {
                ...
                null !== u) {
                    var t = T(this.CGI.getDigitalChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort)
                      , n = new K
                      , r = {
                        type: "GET",
                        url: t,
            ...
            e.prototype.getZeroChannelInfo = function(e, n) {
                var t = T(this.CGI.getZeroChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getStreamChannels = function(e, n) {
                if (0 != e.iAnalogChannelNum)
                    var t = T(this.CGI.getStreamChannels.analog, e.szHttpProtocol, e.szIP, e.iCGIPort);
                else
                    t = T(this.CGI.getStreamChannels.digital, e.szHttpProtocol, e.szIP, e.iCGIPort);
                var r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getPPPoEStatus = function(e, n) {
                var t = T(this.CGI.getPPPoEStatus, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getUPnPPortStatus = function(e, n) {
                var t = T(this.CGI.getUPnPPortStatus, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getNetworkBond = function(e, n) {
                var t = T(this.CGI.getNetworkBond, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getNetworkInterface = function(e, n) {
                var t = T(this.CGI.getNetworkInterface, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getPortInfo = function(e, n) {
                var t = T(this.CGI.getPortInfo, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.startVoiceTalk = function(e, t) {
                var n = T(this.CGI.startVoiceTalk.open, e.szHttpProtocol, e.szIP, e.iCGIPort, t)
                  , r = T(this.CGI.startVoiceTalk.close, e.szHttpProtocol, e.szIP, e.iCGIPort, t)
                  , s = T(this.CGI.startVoiceTalk.audioData, e.szHttpProtocol, e.szIP, e.iCGIPort, t);
            ...
            e.prototype.ptzAutoControl = function(s, e, o, i) {
                var t = o.iChannelID
                  , a = ""
                  , u = "";
                if (i.iPTZSpeed = i.iPTZSpeed < 7 ? 15 * i.iPTZSpeed : 100,
                e && (i.iPTZSpeed = 0),
                s.szDeviceType != D)
                    a = t <= s.iAnalogChannelNum ? T(this.CGI.ptzAutoControl.analog, s.szHttpProtocol, s.szIP, s.iCGIPort, o.iChannelID) : o.bShttpIPChannel ? T(this.CGI.ptzAutoControl.digital, s.szHttpProtocol, s.szIP, s.iCGIPort, o.iChannelID - s.oStreamCapa.iIpChanBase + 1 + s.iAnalogChannelNum) : T(this.CGI.ptzAutoControl.digital, s.szHttpProtocol, s.szIP, s.iCGIPort, o.iChannelID),
                    u = "<?xml version='1.0' encoding='UTF-8'?><autoPanData><autoPan>" + i.iPTZSpeed + "</autoPan></autoPanData>";
                else {
                    0 === i.iPTZSpeed && (e = !0);
                    var n = 99;
                    e && (n = 96),
                    a = T(this.CGI.ptzAutoControl.ipdome, s.szHttpProtocol, s.szIP, s.iCGIPort, o.iChannelID, n)
                }
                var r = new K
                  , c = {
                    type: "PUT",
                ...
                v.extend(c, {
                    success: function(e) {
                        o.bPTZAuto = !o.bPTZAuto,
                        i.success && i.success(e)
                    },
                    error: function(e, t) {
                        if (d == s.szDeviceType || z == s.szDeviceType) {
                            a = o.bShttpIPChannel ? T(l.CGI.ptzControl.analog, s.szHttpProtocol, s.szIP, s.iCGIPort, o.iChannelID - s.oStreamCapa.iIpChanBase + 1 + s.iAnalogChannelNum) : T(l.CGI.ptzControl.analog, s.szHttpProtocol, s.szIP, s.iCGIPort, o.iChannelID),
                            u = "<?xml version='1.0' encoding='UTF-8'?><PTZData><pan>" + i.iPTZSpeed + "</pan><tilt>0</tilt></PTZData>";
                            var n = new K
                              , r = {
                                type: "PUT",
                                url: a,
            ...
            e.prototype.ptzControl = function(e, t, n, r) {
                ...
                o = u != this.CGI.ptzFocus && u != this.CGI.ptzIris || e.szDeviceType != d && e.szDeviceType != D && e.szDeviceType != z ? s <= e.iAnalogChannelNum ? T(u.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID) : n.bShttpIPChannel ? T(u.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : T(u.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID) : T(u.ipc, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID);
                var c = new K
                  , l = {
                    type: "PUT",
                    url: o,
            ...
            e.prototype.setPreset = function(e, t, n) {
                ...
                s += "<PTZPreset>",
                s += "<id>" + n.iPresetID + "</id>",
                e.szDeviceType != D && (s += "<presetName>Preset" + n.iPresetID + "</presetName>"),
                s += "</PTZPreset>";
                var o = new K
                  , i = {
                    type: "PUT",
            ...
            e.prototype.recordSearch = function(e, i) {
                ...
                t = T(this.CGI.recordSearch, e.szHttpProtocol, e.szIP, e.iCGIPort),
                n = "<?xml version='1.0' encoding='UTF-8'?><CMSearchDescription><searchID>" + new te + "</searchID><trackList><trackID>" + (100 * r + s) + "</trackID></trackList><timeSpanList><timeSpan><startTime>" + o + "</startTime><endTime>" + a + "</endTime></timeSpan></timeSpanList><maxResults>40</maxResults><searchResultPostion>" + i.iSearchPos + "</searchResultPostion><metadataList><metadataDescriptor>//metadata.ISAPI.org/VideoMotion</metadataDescriptor></metadataList></CMSearchDescription>";
                var u = new K
                  , c = {
                    type: "POST",
                    url: t,
                ...
                v.extend(c, {
                    success: function(e) {
                        ...
                        t.push("<responseStatus>" + re.$XML(e).find("responseStatus").eq(0).text() + "</responseStatus>"),
                        t.push("<responseStatusStrg>" + re.$XML(e).find("responseStatusStrg").eq(0).text() + "</responseStatusStrg>"),
                        t.push("<numOfMatches>" + re.$XML(e).find("numOfMatches").eq(0).text() + "</numOfMatches>"),
                        t.push("<matchList>");
                        for (var n = re.$XML(e).find("searchMatchItem", !0), r = 0, s = n.length; r < s; r++) {
                            var o = n[r];
                            t.push("<searchMatchItem>"),
                            t.push("<trackID>" + re.$XML(o).find("trackID").eq(0).text() + "</trackID>"),
                            t.push("<startTime>" + re.$XML(o).find("startTime").eq(0).text() + "</startTime>"),
                            t.push("<endTime>" + re.$XML(o).find("endTime").eq(0).text() + "</endTime>"),
                            t.push("<playbackURI>" + v.escape(re.$XML(o).find("playbackURI").eq(0).text()) + "</playbackURI>"),
                            t.push("<metadataDescriptor>" + re.$XML(o).find("metadataDescriptor").eq(0).text().split("/")[1] + "</metadataDescriptor>"),
                            t.push("</searchMatchItem>")
                        }
                        t.push("</matchList>"),
                        t.push("</CMSearchResult>"),
            ...
            e.prototype.startPlayback = function(t, n) {
                var r = n.iWndIndex
                  ...
                  , o = n.szEndTime
                  , i = t.szIP;
                if ("rtsp://" === n.urlProtocol && (i = A(i)),
                Z())
                    if (p.proxyAddress) {
                        v.cookie("webVideoCtrlProxy", i + ":" + n.iPort, {
                            raw: !0
                        }),
                        e = T(n.cgi, n.urlProtocol, p.proxyAddress.ip, p.proxyAddress.wsport, n.iChannelID);
                        var a = i + ":" + n.iPort;
                ...
                if (Z()) {
                    ...
                    0 == y.HWP_Play(e, t.szAuth, r, s, o) ? (c(),
                    l.resolve()) : l.reject()
                }
                return l
            }
            ...
            e.prototype.startDownloadRecord = function(e, t) {
                var n = T(this.CGI.startDownloadRecord, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = "<?xml version='1.0' encoding='UTF-8'?><downloadRequest><playbackURI> " + v.escape(t.szPlaybackURI) + "</playbackURI></downloadRequest>";
                return Z() ? (n = B(n),
                y.JS_StartDownload(n, e.szAuth, t.szFileName, r)) : y.HWP_StartDownload(n, e.szAuth, t.szFileName, r, t.bDateDir)
            }
            ,
            e.prototype.exportDeviceConfig = function(e, t) {
                var n = T(this.CGI.downloaddeviceConfig, e.szHttpProtocol, e.szIP, e.iCGIPort);
                if (Z()) {
                    var r = {
                        type: "PUT",
                        url: n,
            ...
            e.prototype.importDeviceConfig = function(e, t, n) {
                ...
                if (Z()) {
                    var s = {
                      ...
                      , o = new K;
                    return o.setRequestParam(s),
                    o.submitRequest(),
                    r = B(r),
                    n && (r = v.exportPasswordDeviceConfig(r, n)),
                    y.JS_UploadFile(r)
                }
                return n && (r = v.exportPasswordDeviceConfig(r, n)),
            ...
            e.prototype.restore = function(e, t, n) {
                var r = T(this.CGI.restore, e.szHttpProtocol, e.szIP, e.iCGIPort, t)
                  , s = new K
                  , o = {
                    type: "PUT",
                    url: r,
            ...
            e.prototype.startUpgrade = function(e, t) {
                $.Deferred();
                var n = T(this.CGI.startUpgrade.upgrade, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = T(this.CGI.startUpgrade.status, e.szHttpProtocol, e.szIP, e.iCGIPort);
                return szRet = y.HWP_StartUpgrade(n, r, e.szAuth, t.szFileName)
            }
            ,
            e.prototype.asyncstartUpgrade = function(e, t) {
                var n = $.Deferred()
                  , r = T(this.CGI.startUpgrade.upgrade, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , s = T(this.CGI.startUpgrade.status, e.szHttpProtocol, e.szIP, e.iCGIPort);
                if (Z())
                    r = B(r),
                    s = B(s),
                    y.JS_StartUpgradeEx(r, s).then(function(e) {
                        n.resolve(e)
                    }, function() {
                        n.reject(o)
                    });
            ...
            e.prototype.set3DZoom = function(e, t, n, r) {
                var s = "";
                if (s = t.iChannelID <= e.iAnalogChannelNum ? T(this.CGI.set3DZoom.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID) : t.bShttpIPChannel ? T(this.CGI.set3DZoom.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : T(this.CGI.set3DZoom.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID),
                Z())
                    var o = v.loadXML(n)
                    ...
                    o = v.loadXML(n),
                    i = parseInt(re.$XML(o).find("StartPoint").eq(0).find("positionX").eq(0).text(), 10),
                    a = parseInt(re.$XML(o).find("StartPoint").eq(0).find("positionY").eq(0).text(), 10),
                    u = parseInt(re.$XML(o).find("EndPoint").eq(0).find("positionX").eq(0).text(), 10),
                    c = parseInt(re.$XML(o).find("EndPoint").eq(0).find("positionY").eq(0).text(), 10);
                var l = "<?xml version='1.0' encoding='UTF-8'?><Position3D><StartPoint><positionX>" + i + "</positionX><positionY>" + (255 - a) + "</positionY></StartPoint><EndPoint><positionX>" + u + "</positionX><positionY>" + (255 - c) + "</positionY></EndPoint></Position3D>"
                  , d = new K
                  , p = {
                    type: "PUT",
                    url: s,
            ...
            e.prototype.getSDKCapa = function(e, n) {
                var t = T(this.CGI.SDKCapabilities, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.deviceCapturePic = function(e, t, n, r) {
                t = 100 * t + 1;
                var s, o, i = -1, a = T(this.CGI.deviceCapture.channels, e.szHttpProtocol, e.szIP, e.iCGIPort, t), u = [];
                if (v.isInt(r.iResolutionWidth) && u.push("videoResolutionWidth=" + r.iResolutionWidth),
                v.isInt(r.iResolutionHeight) && u.push("videoResolutionHeight=" + r.iResolutionHeight),
                0 < u.length && (a += "?" + u.join("&")),
                Z()) {
                    a = B(a),
                    s = a,
                    o = n,
                    $("body").append('<a id="jsplugin_download_a" href="' + s + '" download=' + o + '.jpg><li id="jsplugin_download_li"></li></a>'),
                    $("#jsplugin_download_li").trigger("click"),
                    $("#jsplugin_download_a").remove(),
                    i = 0
                } else
                    i = y.HWP_DeviceCapturePic(a, e.szAuth, n, r.bDateDir);
                return i
            }
            ,
            ...
            e.prototype.sessionV2Login = function(e, t, n, r, s, o, i, a) {
                ...
                var c = parseInt(re.$XML(i).find("sessionIDVersion").eq(0).text(), 10)
                  ...
                  , P = !1
                  , I = "";
                0 < re.$XML(i).find("isIrreversible", !0).length && (P = "true" === re.$XML(i).find("isIrreversible").eq(0).text(),
                ...
                S += "<isSessionIDValidLongTerm>" + l + "</isSessionIDValidLongTerm>",
            ...
            e.prototype.sessionLogin = function(e, t, n, r, s, o, i) {
                ...
                var u = T(this.CGI.sessionLogin, a, e, n)
                  ...
                  , p = !1
                  , h = "";
                0 < re.$XML(o).find("isIrreversible", !0).length && (p = "true" === re.$XML(o).find("isIrreversible").eq(0).text(),
            ...
            e.prototype.sessionHeartbeat = function(e, t, n) {
                var r = T(this.CGI.sessionHeartbeat, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , s = new K
                  , o = {
                    type: "PUT",
                    url: r,
            ...
            e.prototype.sessionLogout = function(e, n) {
                var t = T(this.CGI.sessionLogout, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "PUT",
                    url: t,
            ...
            e.prototype.getSystemCapa = function(e, n) {
                var t = T(this.CGI.systemCapabilities, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            n.prototype.getAnalogChannelInfo = function(e, i) {
                var t = T(this.CGI.getAnalogChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , n = new K
                  , r = {
                    type: "GET",
                    url: t,
            ...
            n.prototype.getPortInfo = function(o, i) {
                var e = T(this.CGI.getPortInfo, o.szHttpProtocol, o.szIP, o.iCGIPort)
                  , t = new K
                  , n = {
                    type: "GET",
                    url: e,
                ...
                v.extend(n, {
                    success: function(e) {
                        ...
                        for (var t = re.$XML(e).find("AdminAccessProtocol", !0), n = 0, s = t.length; n < s; n++) {
                            ...
                            r.push("<id>" + re.$XML(e).find("id").eq(0).text() + "</id>"),
                            r.push("<enabled>" + re.$XML(e).find("enabled").eq(0).text() + "</enabled>"),
                            r.push("<protocol>" + re.$XML(e).find("protocol").eq(0).text().toUpperCase() + "</protocol>"),
                            r.push("<portNo>" + re.$XML(e).find("portNo").eq(0).text() + "</portNo>"),
                            r.push("</AdminAccessProtocol>")
                        }
            ...
            n.prototype.getStreamDynChannels = function(e, n) {
                var t = T(this.CGI.getStreamDynChannels, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new K
                  , s = {
                    type: "GET",
                    url: t,
            ...
            n.prototype.startRealPlay = function(e, t) {
                ...
                r = t.bZeroChannel ? T(t.cgi.zeroChannels, t.urlProtocol, s, t.iPort, n) : T(t.cgi.channels, t.urlProtocol, s, t.iPort, n);
            ...
            n.prototype.ptzAutoControl = function(s, e, o, i) {
                ...
                e && (i.iPTZSpeed = 0),
                s.szDeviceType != D)
                    a = T(this.CGI.ptzAutoControl, s.szHttpProtocol, s.szIP, s.iCGIPort, t),
                    u = "<?xml version='1.0' encoding='UTF-8'?><PTZData><pan>" + i.iPTZSpeed + "</pan><tilt>0</tilt></PTZData>";
                else {
                    var n = 99;
                    e && (n = 96),
                    a = T(this.CGI.goPreset, s.szHttpProtocol, s.szIP, s.iCGIPort, t, n)
                }
                var r = new K
                  , c = {
                    type: "PUT",
                ...
                v.extend(c, {
                    ...
                    error: function(e, t) {
                        if (s.szDeviceType != D) {
                            a = T(l.CGI.ptzControl, s.szHttpProtocol, s.szIP, s.iCGIPort, o.iChannelID);
                            var n = new K
                              , r = {
                                type: "PUT",
                                url: a,
            ...
            n.prototype.setPreset = function(e, t, n) {
                t.iChannelID;
                var r, s = "";
                r = T(this.CGI.setPreset, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, n.iPresetID),
                s = "<?xml version='1.0' encoding='UTF-8'?>",
                s += "<PTZPreset>",
                s += "<id>" + n.iPresetID + "</id>",
                e.szDeviceType != D && (s += "<presetName>Preset" + n.iPresetID + "</presetName>"),
            ...
            n.prototype.goPreset = function(e, t, n) {
                var r;
                t.iChannelID;
                r = T(this.CGI.goPreset, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, n.iPresetID);
                var s = new K
                  , o = {
                    type: "PUT",
                    url: r,
            ...
            n.prototype.exportDeviceConfig = function(e) {
                var t = T(this.CGI.downloaddeviceConfig, e.szHttpProtocol, e.szIP, e.iCGIPort);
                return Z() ? -1 : y.HWP_ExportDeviceConfig(t, e.szAuth, "", 0)
            }
            ,
            n.prototype.importDeviceConfig = function(e, t) {
                var n = T(this.CGI.uploaddeviceConfig, e.szHttpProtocol, e.szIP, e.iCGIPort);
            ...
            n.prototype.set3DZoom = function(e, t, n, r) {
                var s = T(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID)
                  , o = new K
                  , i = {
                    type: "PUT",
                    url: s,
            ...
            n.prototype.deviceCapturePic = function(e, t, n, r) {
                t = 100 * t + 1;
                var s = T(this.CGI.deviceCapture.channels, e.szHttpProtocol, e.szIP, e.iCGIPort, t)
                  , o = [];
                return v.isInt(r.iResolutionWidth) && o.push("videoResolutionWidth=" + r.iResolutionWidth),
                v.isInt(r.iResolutionHeight) && o.push("videoResolutionHeight=" + r.iResolutionHeight),
                0 < o.length && (s += "?" + o.join("&")),
            ...
            Y.prototype.eq = function(e, t) {
                var n = this.elems[this.length - 1].length
                  , r = null;
                return 0 < n && e < n && (r = this.elems[this.length - 1][e]),
            ...
            ee.prototype.toXMLStr = function(t) {
                ...
                return -1 == n.indexOf("<?xml") && (n = "<?xml version='1.0' encoding='utf-8'?>" + n),
                n
            }
            ,
            ...
            ee.prototype.Base64 = {
                ...
                encode: function(e) {
                    ...
                    for (e = ee.prototype.Base64._utf8_encode(e); c < e.length; )
                        ...
                        u = u + this._keyStr.charAt(s) + this._keyStr.charAt(o) + this._keyStr.charAt(i) + this._keyStr.charAt(a);
                    return u
                },
                decode: function(e) {
                    var t, n, r, s, o, i, a = "", u = 0;
                    for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); u < e.length; )
                        t = this._keyStr.indexOf(e.charAt(u++)) << 2 | (s = this._keyStr.indexOf(e.charAt(u++))) >> 4,
                        n = (15 & s) << 4 | (o = this._keyStr.indexOf(e.charAt(u++))) >> 2,
                        r = (3 & o) << 6 | (i = this._keyStr.indexOf(e.charAt(u++))),
                ...
                _utf8_decode: function(e) {
                    for (var t = "", n = 0, r = c1 = c2 = 0; n < e.length; )
                        ...
                        n++) : 191 < r && r < 224 ? (c2 = e.charCodeAt(n + 1),
            ...
            ee.prototype.encodeAES = function(e, t, n, r) {
                ...
                if ("ecb" === r)
                    for (var o = e.length, i = 0; 0 < o; )
                        s += 16 < o ? aes_encrypt(e.substring(i, i + 16), t, !0) : aes_encrypt(e.substring(i), t, !0),
                        o -= 16,
                        i += 16;
                else {
            ...
            ee.prototype.sha256 = function(e) {
                ...
                return function(e) {
                    ...
                    l = 0; l < e.length; l += 16) {
                        ...
                        c = P[7],
                        d = 0; d < 64; d++)
                            I[d] = d < 16 ? e[d + l] : m(m(m(S(I[d - 2], 17) ^ S(I[d - 2], 19) ^ I[d - 2] >>> 10, I[d - 7]), S(I[d - 15], 7) ^ S(I[d - 15], 18) ^ I[d - 15] >>> 3), I[d - 16]),
                            p = m(m(m(m(c, S(i, 6) ^ S(i, 11) ^ S(i, 25)), i & a ^ ~i & u), f[d]), I[d]),
                            h = m(S(n, 2) ^ S(n, 13) ^ S(n, 22), n & r ^ n & s ^ r & s),
                            c = u,
                            u = a,
                            a = i,
                            i = m(o, p),
            ...
            return c = u = "webVideoCtrl" + ne,
            "object" != typeof window.attachEvent && v.browser().msie && (v.createEventScript(u, "GetSelectWndInfo(SelectWndInfo)", "GetSelectWndInfo(SelectWndInfo);"),
            v.createEventScript(u, "ZoomInfoCallback(szZoomInfo)", "ZoomInfoCallback(szZoomInfo);"),
            v.createEventScript(u, "GetHttpInfo(lID, lpInfo, lReverse)", "GetHttpInfo(lID, lpInfo, lReverse);"),
            v.createEventScript(u, "PluginEventHandler(iEventType, iParam1, iParam2)", "PluginEventHandler(iEventType, iParam1, iParam2);"),
            v.createEventScript(u, "RemoteConfigInfo(lID)", "RemoteConfigInfo(lID);"),
            v.createEventScript(u, "KeyBoardEventInfo(iKeyCode)", "KeyBoardEventInfo(iKeyCode);")),
            this
        }()
