...
const Overview = () => {
  ...
  return (
    <>
      <Head>
        <title>Dashboard: Overview | ETLAS</title>
      </Head>
      <Box
        component="main"
        sx={{
              ...
              <Grid container item xs={12} md={7} spacing={4}>
                <Grid item xs={12}>
                  <Typography variant={'h5'}>
                    Alerts (24hrs)
                    <Button
                      endIcon={<NotificationImportantOutlined />}
                      href="dashboard/logs/eventlog"
                    >
                      View Alerts
                    </Button>
                  </Typography>
                ...
                <Grid item xs={12}>
                  <Typography variant={'h5'}>Device Conditions</Typography>
                </Grid>
