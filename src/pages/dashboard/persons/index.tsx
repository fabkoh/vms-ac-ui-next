          ...
          <Box sx={{ mb: 4 }}>
            <Grid container justifyContent="space-between" spacing={3}>
              ...
              <Grid item>
                ...
                >
                    ...
                    <MenuItem component={NextLink} href={personCreateLink} disableRipple>
                      <AddIcon />
                      &#8288;Create
                    </MenuItem>
                  
                    <MenuItem component={NextLink} href={getPersonIdsEditLink(selectedPersons)} disableRipple disabled={buttonBlock}>
                      <EditIcon />
                      &#8288;Edit
                    </MenuItem>
            ...
            <Grid container justifyContent="space-between" spacing={3}>
              ...
              <Grid item>
                  ...
                  <Button component={NextLink} href={personLostAndFoundLink} sx={{ m: 2 }} variant="contained" color="error">
                    Lost & Found
                  </Button>
              </Grid>
            </Grid>
