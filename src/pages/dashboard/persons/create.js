...
import { saveCredentialApi } from "../../../api/credentials";
...
const cardError = (v) => {
    return isObject(v) && (v.firstNameBlank || v.lastNameBlank || v.uidInUse || v.uidRepeated || v.credentialRepeatedIds.length > 0 || v.credentialUidRepeatedIds.length > 0)
};
