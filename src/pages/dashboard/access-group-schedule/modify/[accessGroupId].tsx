            ...
            >
                <Container maxWidth="xl">
                    <Box sx={{ mb: 4 }}>
                            ...
                            <Link
                                color="textPrimary"
                                component={NextLink} href={`/dashboard/access-groups/details/${accessGroupId}`}
                                sx={{
                                    alignItems: 'center',
                                    display: 'flex'
                                }}
...
mb={2}>
                                ...
                                <Grid item>
                                        ...
                                        <Button component={NextLink} href={accGrp? getAccessGroupDetailsLink(accGrp) : accessGroupListLink}
                                            size="large"
                                            variant="outlined"
                                            color="error"
                                        >
