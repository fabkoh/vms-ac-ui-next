...
import {
  filterVideoByStringPlaceholder,
  videoRecorderCreateLink,
  filterRecorderByString,
  getVideoRecordersEditLink,
  filterRecorderByStatus,
...
const RecorderList = () => {
  ...
  const selectedSomeRecorders =
    selectedRecorders.length > 0 && !selectedAllRecorders;
  const handleSelectAllRecorders = (e) =>
    setSelectedRecorders(
      e.target.checked ? recorders.map((e) => e.recorderId) : []
    );
  ...
  const paginatedRecorders = applyPagination(
    filteredRecorders,
    page,
    rowsPerPage
  );
      ...
      >
        ...
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            <Grid container justifyContent="space-between" spacing={3}>
              ...
              <Grid item>
                ...
                >
                  ...
                  <MenuItem
                    component={NextLink}
                    href={getVideoRecordersEditLink(selectedRecorders)}
                    disableRipple
            ...
            >
              <Button startIcon={<Upload fontSize="small" />} sx={{ m: 1 }}>
                Import
              </Button>
              <Button startIcon={<Download fontSize="small" />} sx={{ m: 1 }}>
                Export
              </Button>
              <Tooltip
...
RecorderList.getLayout = (page) => (
  <AuthGuard>
    <Script
      src="/static/sdk/codebase/jquery-1.12.1.min.js"
      strategy="afterInteractive"
    />
    <Script
      src="/static/sdk/codebase/encryption/AES.js"
      strategy="afterInteractive"
    />
    <Script
      src="/static/sdk/codebase/encryption/cryptico.min.js"
      strategy="afterInteractive"
    />
    <Script
      src="/static/sdk/codebase/encryption/crypto-3.1.2.min.js"
      strategy="afterInteractive"
    />
    <Script
      id="videonode"
