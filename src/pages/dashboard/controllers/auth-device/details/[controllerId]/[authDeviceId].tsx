                ...
                <Container maxWidth="md">
                    <div>
                        <Box sx={{ mb: 4 }}>
                                ...
                                <Link
                                    color="textPrimary"
                                    component={NextLink} href={getControllerDetailsLinkWithId(controllerId)}
                                    sx={{
                                        alignItems: 'center',
                                        display: 'flex'
                                    }}
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                        ...
                                        <MenuItem component={NextLink} href={getAuthdeviceEditLink(controllerId,authDeviceId)} disableRipple>
                                            <EditIcon />
                                            &#8288;Edit
                                        </MenuItem>
                                    <MenuItem
