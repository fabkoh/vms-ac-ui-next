...
class NotificationsConfigApi {
  ...
  changeSMSNotificationEnablementStatus(): Promise<Response | { status: number }> {
  ...
  changeEmailNotificationEnablementStatus(): Promise<Response | { status: number }> {
    // if disabled, it will enable, if enabled it will disable
