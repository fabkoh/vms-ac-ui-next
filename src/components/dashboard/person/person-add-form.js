              ...
              >
                ...
                >
                  <TextField
                    ...
                    value={person.uid}
                    //placeholder="Company Unique ID. Autogenerated if empty."
                    //placeholder when screen minimises to the mobile screen size, the font size are too large
                    required
                  />
                </Grid>
                <Grid
                ...
                >
                  <TextField
                    fullWidth
                    error={!person.valid.mobileNumber || !(person.valid.mobileNumberNotRepeated && person.valid.mobileNumberNotInUse)}
