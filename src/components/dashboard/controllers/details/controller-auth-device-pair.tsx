								...
								return (
									<TableRow hover key={i}>
										...
										<TableCell>							
												...
												<Link component={NextLink} href={getAuthdeviceDetailsLink(controllerId,authDeviceId)} color="inherit">
										...
										<TableCell>
											...
											<IconButton component={NextLink} href={ getAuthdeviceEditLink(controllerId,authDeviceId) }>
												<PencilAlt fontSize="small" />
											</IconButton>
                                            
											<IconButton component={NextLink} href={ getAuthdeviceDetailsLink(controllerId,authDeviceId) }>
