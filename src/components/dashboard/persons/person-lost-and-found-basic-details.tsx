...
export const PersonLostDetails = (props) => {
  const { 
    personId,
    personFirstName, 
    personLastName, 
        ...
        >
          {
            accessGroup ? (
              <Link component="a">
                  ...
                  <Chip component={NextLink} href={getAccessGroupDetailsLink(accessGroup)} color={accessGroup.isActive ? "default" : "error"}
