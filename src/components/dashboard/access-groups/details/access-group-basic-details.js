...
export const AccessGroupBasicDetails = (props) => {
  ...
  const { accessGroupName, accessGroupDesc, isActive, isInSchedule } =
    props.accessGroup;
  ...
  return (
    <BasicDetailsCard>
      <PropertyList>
        ...
        <PropertyListItem align={align} divider label="Status" value={isActive}>
          {(!isActive && (
            <SeverityPill color="error">NOT ACTIVE</SeverityPill>
