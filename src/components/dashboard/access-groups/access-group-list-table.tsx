                ...
                >
                  <TableCell padding="checkbox">
                    <Checkbox
                      ...
                      onChange={(event) =>
                        props.handleSelectOneAccessGroup(
                          event,
                          accGroup.accessGroupId
                        )
                      }
                  ...
                  <TableCell width="15%">
                    <Typography width={130} noWrap>
                      {(Array.isArray(accGroup.persons) &&
                  ...
                  <TableCell width="15%">
                    {Array.isArray(accGroup.entrances) &&
                    accGroup.entrances.length > 0 ? (
                  ...
                  <TableCell width="20%" align="center">
                      ...
                      <IconButton component={NextLink} href={{
