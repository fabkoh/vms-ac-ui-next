  ...
  return (
    <ErrorCard
      error={
        ...
        // accessGroupNameDuplicated   ||
        // accessGroupPersonDuplicated ||
        entranceScheduleNameBlank || submitFailed
      }
    >
      <CardHeader
        avatar={
        ...
        <Stack spacing={3}>
          <Grid item md={6} xs={12}>
            <TextField
              ...
              helperText={
                entranceScheduleNameBlank &&
                'Error: entrance schedule name cannot be blank'
          ...
          <Collapse in={expanded}>
            <Stack spacing={3}>
              ...
              <Divider />
              <Grid item md={12} xs={12} container alignItems="center"></Grid>
            </Stack>
          </Collapse>
        </Stack>
      </CardContent>
