      ...
      <DialogContent>
        <Box marginTop={1} marginBottom={5}>
          <Alert severity="info" variant="outlined">
            The new event managements highlighted below has trigger/output
            configurations that clash with existing event managements.
            <br />
            <br />
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell>
                Event Management(s) with Clashing Trigger/Output Configurations
              </TableCell>
