        ...
        <Table>
          ...
          <TableBody>
            {eventsManagements.map((eventManagement, i) => {
              const IsEventsManagementSelected =
                selectedEventsManagement.includes(
              ...
              return (
                <TableRow hover key={i}>
                  ...
                  <TableCell width="18%">
                    {displayEntranceOrController(eventManagement)}
                  </TableCell>
                  <TableCell width="15%">
                  ...
                  <TableCell width="15%">
                    {eventActionInputDescription(eventManagement.inputEvents)}
                  </TableCell>
                  <TableCell width="15%">
                    {eventActionOutputDescription(
                      eventManagement.outputActions,
                      smsConfig,
                      emailConfig
                    )}
                  </TableCell>
                  {/* <TableCell width="1%">
                                                    ...
                                                    <IconButton component={NextLink} href={eventsManagementEditLink(eventManagement.eventsManagementId)}>
                                                        <PencilAltIcon fontSize="small" />
                                                    </IconButton>
                                            </TableCell> */}
                  <TableCell width="1%">
                    
                      <IconButton component={NextLink} href={getEventsManagementDetailsLink(
                        eventManagement.eventsManagementId
                      )}>
